...
В данном исследовании поставлена задача построить две модели:  
...
С помощью пайплайнов мной были подготовелны данные и протестированны несколько моделей с перебором вручную настроенных гиперпараметров:   
